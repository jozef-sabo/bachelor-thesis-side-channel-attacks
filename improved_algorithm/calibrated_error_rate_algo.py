...
def run_dataset(
        ...
        L: int,
        t: int,
        error_rate_set: int | None) -> int:
    E, d, error_rate, blinded_with_errors, _, _, curve_size, R = load_binary(file_path, None)
    K = curve_size
    if error_rate_set is not None:
        error_rate = error_rate_set
...
def main():
    ...
    error_rate_set = 22
    print(run_dataset(file_path, N=N, L=L, t=t, error_rate_set=error_rate_set))
